...
import com.epam.hw3.hotelproject.timed.TimedController;
import com.epam.hw3.hotelproject.timed.TimedHandlerBeanPostProcessor;
...
@Configuration
@ComponentScan(basePackages = "com.epam.hw3.hotelproject")
@EnableWebMvc
